...
import com.cxf.febs.common.core.utils.FileUtil;
import com.cxf.febs.sever.generator.helper.GeneratorHelper;
...
public class GeneratorController {
    ...
    public void generate(@NotBlank(message = "{required}") String name,
        ...
        GeneratorConfig generatorConfig = generatorConfigService.getGeneratorConfig();
