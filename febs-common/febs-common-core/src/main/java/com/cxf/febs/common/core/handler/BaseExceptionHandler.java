...
import com.cxf.febs.common.core.exception.FileDownloadException;
...
public class BaseExceptionHandler {
    ...
    @ResponseStatus(HttpStatus.BAD_REQUEST)
    public FebsResponse handleMethodArgumentNotValidException(MethodArgumentNotValidException e) {
        StringBuilder message = new StringBuilder();
