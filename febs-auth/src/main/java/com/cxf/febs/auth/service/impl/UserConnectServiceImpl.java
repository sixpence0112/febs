...
import com.cxf.febs.auth.mapper.UserConnectionMapper;
...
public class UserConnectServiceImpl extends ServiceImpl<UserConnectionMapper, UserConnection> implements UserConnectionService {
    @Override
